...
export default function NotFound() {
  ...
  return (
    <>
      <Cursor />
      <Navbar />
      <main className="bg-white text-black pt-24 md:pt-32 pb-20 md:pb-32 min-h-screen flex items-center justify-center">
          ...
          >
            <motion.div className="mb-8" variants={itemVariants}>
              <div className="relative">
                <div className="text-[150px] md:text-[250px] font-bold text-blue-primary opacity-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0">
                  404
                </div>
                <svg
                  width="396"
            ...
            <motion.div className="mb-10 max-w-lg" variants={itemVariants}>
              <SplitText
                tag="p"
            ...
            >
              <Link 
                href="/" 
                className="px-8 py-3 bg-blue-primary text-white text-sm font-medium hover:bg-blue-secondary transition-colors duration-300"
              >
                Back to Home
              </Link>
              <Link 
